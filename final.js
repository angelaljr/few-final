  ...
  getTheData: function () {
    ...
    .then (response => {
      response.forEach(entry => {
        $('.container').append(
          `<div class="entry">${entry.firstname} ${entry.email}, ${entry.description}</div>` 
        )
      })
    });
  }
...
//   var value = document.getElementsByClassName("mySearch").value;
...
let lastWord = document.querySelector('#thank');
...
//mapbox
mapboxgl.accessToken = 'pk.eyJ1IjoiYW5qaHl5Z2giLCJhIjoiY2t4Nmh3b3pmMDI2bjJ4azNkcm9mMXhnNyJ9.yfJAlErAXZqqCfjM0xm3uA';
const map = new mapboxgl.Map({
    container: 'map', // container ID
    style: 'mapbox://styles/mapbox/streets-v11', // style URL
    center: [-123.1207, 49.246292], // starting position [lng, lat]
